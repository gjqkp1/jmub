        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    ...
                    caption="🐊 gjk_e the best 🐊\n- - - - - - - - - - - - - - - - - - - - - - - -\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n- - - - - - - - - - - - - - - - - - - - - - - -\nThE KiNgS ❲ @gjk_e - @gjqkp ❳ ".format(
...
async def _(event):
    ...
    try:
        ...
        try:
            ch = await jmub(
                functions.channels.CreateChannelRequest(
                    title="gjk_e HUNTER - تثبيت جمثون",
                    about="This channel to hunt username by - @gjk_e ",
                )
            )
            ch = ch.updates[1].channel_id
